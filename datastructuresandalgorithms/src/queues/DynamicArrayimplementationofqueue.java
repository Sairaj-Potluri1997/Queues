...
public class DynamicArrayimplementationofqueue {
	...
	public DynamicArrayimplementationofqueue() {
	...
	//method to remove an element from top of the queue
	public void dequeue() {
		if (isQueueEmpty()) {
...
//method to expand array
	...
	public static void main(String a[]) {
		...
		DynamicArrayimplementationofqueue queue = new DynamicArrayimplementationofqueue();
		queue.enqueue(4);
		queue.dequeue();
		queue.enqueue(56);
		queue.enqueue(2);
